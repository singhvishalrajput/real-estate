...
const About = () => {
  return (
    ...
    className='bg-gray-200 flex flex-col items-center justify-center container mx-auto p-14  md:px-20 lg:px-32 w-full overflow-hidden ' id='About'>
      ...
      <p className='text-silver-500 max-w-80 text-center mb-8'>Passionate About Properties, Dedicated to Your Vision</p>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            <img  src={assets.brand_img} alt="" className='sm:w-1/2 md:w-1/3 md:ml-40 rounded-2xl' />
